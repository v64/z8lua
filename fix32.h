...
namespace z8 {
	...
	struct fix32 {
		...
		inline fix32(double d) : m_bits((int32_t)std::round(std::ldexp(d, 16))) {
		}
		...
		inline int32_t bits() const {
			return m_bits;
		}

		/* Comparisons */
		bool operator==(fix32 x) const {
		...
		/* Math operations */
		fix32 const& operator+() const {
			return *this;
		}
		fix32 operator-() const {
			return frombits(-m_bits);
		}
		fix32 operator~() const {
			return frombits(~m_bits);
		}
		...
		fix32 operator+(fix32 x) const {
			return frombits(m_bits + x.m_bits);
		}
		fix32 operator-(fix32 x) const {
			return frombits(m_bits - x.m_bits);
		}
		...
		/* Free functions */
		static fix32 abs(fix32 a) {
			return a.m_bits > 0 ? a : -a;
		}
		...
		static fix32 ceil(fix32 x) {
			return -floor(-x);
		}
		static fix32 floor(fix32 x) {
		...
		static fix32 fabs(fix32 x) {
			return fix32(std::fabs((double)x));
		}

		static fix32 sin(fix32 x) {
			return fix32(std::sin((double)x));
		}
		static fix32 sinh(fix32 x) {
			return fix32(std::sinh((double)x));
		}
		static fix32 asin(fix32 x) {
			return fix32(std::asin((double)x));
		}

		static fix32 cos(fix32 x) {
			return fix32(std::cos((double)x));
		}
		static fix32 cosh(fix32 x) {
			return fix32(std::cosh((double)x));
		}
		static fix32 acos(fix32 x) {
			return fix32(std::acos((double)x));
		}
		static fix32 tan(fix32 x) {
			return fix32(std::tan((double)x));
		}
		static fix32 tanh(fix32 x) {
			return fix32(std::tanh((double)x));
		}
		static fix32 atan(fix32 x) {
			return fix32(std::atan((double)x));
		}
		static fix32 atan2(fix32 x, fix32 y) {
			return fix32(std::atan2((double)x, (double)y));
		}
		static fix32 fmod(fix32 x, fix32 y) {
			return fix32(std::fmod((double)x, (double)y));
		}
		...
		static fix32 sqrt(fix32 x) {
			return fix32(std::sqrt((double)x));
		}
		static fix32 log(fix32 x) {
			return fix32(std::log((double)x));
		}
		static fix32 log10(fix32 x) {
			return fix32(std::log10((double)x));
		}
		static fix32 exp(fix32 x) {
			return fix32(std::exp((double)x));
		}
		static fix32 frexp(fix32 x, int* i) {
			return fix32(std::frexp((double)x, i));
		}
		static fix32 ldexp(fix32 x, int i) {
			return fix32(std::ldexp((double)x, i));
		}
